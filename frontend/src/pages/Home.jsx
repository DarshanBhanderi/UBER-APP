...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const handleRideConfirmed = (incomingRide) => {
      setVehicleFound(false)
      setWaitingForDriver(true)
      setRide(incomingRide)
    }

    const handleRideStarted = (incomingRide) => {
      setWaitingForDriver(false)
      navigate('/riding', { state: { ride: incomingRide } })
    }
  ...
  const fetchSuggestions = async (input, type) => {
    ...
    try {
      ...
      setErrorMessage(getApiErrorMessage(error, 'Unable to fetch suggestions'))
    }
  }
  ...
  const findTrip = async () => {
    ...
    try {
      ...
      setErrorMessage(getApiErrorMessage(error, 'Unable to calculate fare'))
    }
  }
  ...
  const createRide = async () => {
    ...
    try {
      ...
      setErrorMessage(getApiErrorMessage(error, 'Unable to create ride'))
    }
  }
