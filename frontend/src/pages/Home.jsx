...
const Home = () => {
    ...
    const [pickupSuggestions, setPickupSuggestions] = useState([]); ////-1
    const [destinationSuggestions, setDestinationSuggestions] = useState([]); ////-2
    const [ activeField, setActiveField ] = useState(null)
    const [ fare, setFare ] = useState({})
    const [ vehicleType, setVehicleType ] = useState(null)
    const [ride, setRide] = useState(null); ////-3
